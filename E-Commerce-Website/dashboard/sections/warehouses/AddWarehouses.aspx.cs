...
{
    public partial class AddWarehouses : System.Web.UI.Page
    {
        ...
        {
            string warehouseName = txtName?.Text.Trim() ?? string.Empty;
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                query = "INSERT INTO warehouses VALUES (@Name, @City, @Address, @Phone, @File_url, @Manager_ID);";
                ...
                {
                    filePath = "/storage/files/brochures/warehouses/" + hashedFileName;
                }
