...
namespace E_Commerce_Website.dashboard.sections.branches
{
    public partial class Branches : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            string query = @"SELECT TOP (1000) stores.[id] as id" +
                    ",stores.[name]" +
            ...
            string searchCondition = " WHERE stores.[name] LIKE '%' + @SearchTerm + '%' " +
            ...
            {
                Branches_SQL_DS.SelectCommand = query;
                Branches_SQL_DS.SelectParameters.Clear();

            } else
            {
                Branches_SQL_DS.SelectCommand = query + searchCondition;
                Branches_SQL_DS.SelectParameters.Clear();
